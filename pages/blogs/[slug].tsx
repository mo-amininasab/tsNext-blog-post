    ...
    <Layout title={frontMatter.title}>
      <div className="w-full px-10 py-6 bg-white rounded-lg shadow-md mt-6">
        <div className="flex justify-between items-center mt-4">
          ...
          <CategoryLabel category={frontMatter.category} width={12}/>
        </div>
        <Image src={frontMatter.cover_image} alt={frontMatter.title} className="w-full rounded" width={688} height={500}/>
